...
--
-- Table structure for table `groupsource`
--
...
--
-- Dumping data for table `groupsource`
--

LOCK TABLES `groupsource` WRITE;
/*!40000 ALTER TABLE `groupsource` DISABLE KEYS */;
/*!40000 ALTER TABLE `groupsource` ENABLE KEYS */;
UNLOCK TABLES;
