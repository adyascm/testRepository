...
api.add_resource(flask_wrapper_core.UsersWriteToCsv, urls.WRITE_TO_CSV_FOR_USERS)
...
api.add_resource(flask_wrapper_core.ResourcesWriteToCsv, urls.WRITE_TO_CSV_FOR_RESOURCES)
