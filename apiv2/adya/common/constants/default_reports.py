default_reports = [
    ...
    "selected_entity_type":"","selected_entity_name":"","is_active":False},
    {"name":"System::Exposed Resources Report", "description":"Resources which have been exposed externally","domain_id" :"","frequency":"cron(0 10 1 * ? *)", "report_type":"ExposedResources", "selected_entity":"",
    "selected_entity_type":"","selected_entity_name":"","is_active":False},
    {"name":"Weekly summary", "description":"Weekly summary report","domain_id" :"","frequency":"cron(0 10 ? * 2 *)", "report_type":"WeeklySummary", "selected_entity":"",
        "selected_entity_type":"","selected_entity_name":"","is_active":False}
]
