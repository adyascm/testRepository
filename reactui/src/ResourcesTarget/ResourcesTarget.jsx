...
class ResourcesTarget extends Component {
  constructor(props) {
    super(props);
    ...
    this.columnDefs = [{
      ...
      cellRendererParams: {
        getMimeIcon: (user) => {
          ...
          // console.log("User Perms value is : ", perms);
        ...
        getIsActiveMultiple: params => {
          return this.state.activeRowIndexList.includes(params.node.rowIndex);
        },
  ...
  onResourceCellClick(params) {
    ...
    //this.props.setActiveFile(null); Deactivated to disable right to left
    //this.props.setViewAccessibleClicked(false);
    //this.props.setFilePermissionsMode(); Deactivated to disable right to left
    ...
    if (!activeRowIndexPrev.includes(params.node.rowIndex))
      ...
      var index = activeRowIndexPrev.indexOf(params.node.rowIndex);
      activeRowIndexPrev.splice(index,1);
    }
    this.setState({
