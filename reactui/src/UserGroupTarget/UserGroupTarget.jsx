...
class UserGroupTarget extends Component {
  constructor(props) {
    super(props);
  ...
  onResourceCellClick(params) {
    ...
    //this.props.setActiveUser(null); Commented to deactivate rightToLeft
    //this.props.setViewAccessibleClicked(false);
    //this.props.setUserPermissionsMode(); Commented to deactivate rightToLeft
