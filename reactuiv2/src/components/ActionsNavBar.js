...
class ActionsNavBar extends Component{
    ...
    render(){
          ...
          let dropDownItems = this.props.options.map(item => {
                ...
                <Dropdown.Menu>
                    <Dropdown.Item>
                        <Dropdown text='System'>
                            <Dropdown.Menu>
                                <Dropdown.Item>
                                    <ExportCsvModal isResourceView={this.props.isResourceView} columnHeaders={this.props.columnHeaderDataNameMap} apiFunction={agent.Resources.exportToCsv} filterMetadata={this.props.filterMetadata} />
                                </Dropdown.Item>
                            </Dropdown.Menu>
                        </Dropdown>
                    </Dropdown.Item>
...
export default connect(mapStateToProps, mapDispatchToProps)(ActionsNavBar);